...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'edusoho_demo', 'user' => 'root', 'password' => '', 'driverOptions' => array(), 'wrapperClass' => 'Topxia\\Service\\Common\\Connection'), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c6c27c711ab18c31f2e55bf4ea8516750bd65c90d50fe096c2ee0df9eb79c9e5');
        return $instance;
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'cy8hefxjlc00ggk0scc4gw0wsw00ks0');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $w = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'cy8hefxjlc00ggk0scc4gw0wsw00ks0', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
    ...
    {
        $this->services['session.handler.pdo.connection'] = $instance = new \PDO('mysql:host=127.0.0.1;port=3306;dbname=edusoho_demo', 'root', '');
    ...
    protected function getTemplating_Helper_AssetsService()
    {
        ...
        return $this->services['templating.helper.assets'] = $this->scopedServices['request']['templating.helper.assets'] = new \Symfony\Component\Templating\Helper\CoreAssetsHelper(new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), '7.1.4', '%s?%s'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('cy8hefxjlc00ggk0scc4gw0wsw00ks0');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'zh_CN',
            'secret' => 'cy8hefxjlc00ggk0scc4gw0wsw00ks0',
            'user_partner' => 'none',
            ...
            'kernel.secret' => 'cy8hefxjlc00ggk0scc4gw0wsw00ks0',
            ...
            'twig.options' => array(
                ...
                'paths' => array(
                    '/var/www/html/edusoho/app/../web/customize' => 'customize',
                    '/var/www/html/edusoho/app/../src/Topxia/WebBundle/Resources/views' => 'topxiaweb',
                    '/var/www/html/edusoho/app/../web/themes' => 'theme',
                    '/var/www/html/edusoho/app/../' => 'root',
                ),
