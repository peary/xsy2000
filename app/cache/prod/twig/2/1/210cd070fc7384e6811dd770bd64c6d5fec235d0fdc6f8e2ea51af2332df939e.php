...
class __TwigTemplate_210cd070fc7384e6811dd770bd64c6d5fec235d0fdc6f8e2ea51af2332df939e extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        $context["parameter"] = $this->env->getExtension('topxia_web_twig')->getParametersFromUrl($this->getAttribute($this->getAttribute($_app_, "request", array()), "uri", array()));
        // line 1
...
<div class=\"es-section login-section\">
  <div class=\"logon-tab clearfix\">
    <a href=\"";
        ...
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("login", array("goto" => $__target_path_)), "html", null, true);
        echo "\">";
  ...
  <div class=\"login-main\">
    ";
        // line 15
        if (isset($context["isRegisterEnabled"])) { $_isRegisterEnabled_ = $context["isRegisterEnabled"]; } else { $_isRegisterEnabled_ = null; }
        if ($_isRegisterEnabled_) {
            // line 16
        ...
        ";
            // line 19
            if (isset($context["inviteCode"])) { $_inviteCode_ = $context["inviteCode"]; } else { $_inviteCode_ = null; }
            if (($_inviteCode_ != null)) {
                // line 20
                echo "          <div class=\"alert alert-info alert-sm\">您正在通过<span class=\"color-gray mhs\">";
                if (isset($context["inviteUser"])) { $_inviteUser_ = $context["inviteUser"]; } else { $_inviteUser_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($_inviteUser_, "nickname", array(), "array"), "html", null, true);
                echo "</span>的邀请注册。</div>
        ";
            }
            // line 22
        ...
        ";
            ...
            echo "        ";
            if (isset($context["inviteCode"])) { $_inviteCode_ = $context["inviteCode"]; } else { $_inviteCode_ = null; }
            if (((_twig_default_filter($this->env->getExtension('topxia_web_twig')->getSetting("invite.invite_code_setting"), 0) == 1) && ($_inviteCode_ == null))) {
                // line 96
                echo "        <div class=\"form-group mbl\">
        ...
        ";
            // line 122
            if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
            if ($this->getAttribute($this->getAttribute($_app_, "request", array()), "get", array(0 => "inviteCode", 1 => ""), "method")) {
                // line 123
                echo "        <input type=\"hidden\" id=\"invite_code\" name=\"invite_code\" value=\"";
                if (isset($context["app"])) { $_app_ = $context["app"]; } else { $_app_ = null; }
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($_app_, "request", array()), "get", array(0 => "inviteCode", 1 => ""), "method"), "html", null, true);
                echo "\">
        ";
            }
            // line 125
      ...
      ";
          ...
          <span>
            ";
                ...
                if (isset($context["_target_path"])) { $__target_path_ = $context["_target_path"]; } else { $__target_path_ = null; }
                if (isset($context["inviteCode"])) { $_inviteCode_ = $context["inviteCode"]; } else { $_inviteCode_ = null; }
                echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('http_kernel')->controller("TopxiaWebBundle:Login:oauth2LoginsBlock", array("targetPath" => $__target_path_, "inviteCode" => ((array_key_exists("inviteCode", $context)) ? (_twig_default_filter($_inviteCode_, "")) : ("")))));
                echo "
          </span>
          <div class=\"line\"></div>
        </div>
  ...
  ";
    ...
    {
        return array (  362 => 143,  359 => 142,  357 => 141,  353 => 139,  347 => 137,  344 => 136,  334 => 131,  330 => 129,  328 => 128,  323 => 125,  316 => 123,  313 => 122,  309 => 121,  305 => 120,  296 => 116,  291 => 113,  283 => 108,  278 => 105,  276 => 104,  273 => 103,  264 => 99,  257 => 97,  254 => 96,  250 => 95,  241 => 89,  234 => 87,  225 => 83,  219 => 80,  212 => 79,  209 => 78,  196 => 72,  187 => 68,  181 => 65,  178 => 64,  176 => 63,  169 => 59,  164 => 57,  154 => 52,  149 => 50,  145 => 48,  135 => 43,  130 => 41,  127 => 40,  117 => 35,  112 => 33,  109 => 32,  99 => 27,  94 => 25,  91 => 24,  89 => 23,  86 => 22,  79 => 20,  76 => 19,  70 => 17,  67 => 16,  64 => 15,  58 => 12,  51 => 11,  46 => 8,  43 => 7,  35 => 3,  31 => 1,  28 => 6,  26 => 4,  11 => 1,);
    }
}
