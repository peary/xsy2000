...
class __TwigTemplate_ac5c2d29e9b916541688ccafbe6e074b147842f4bee8f350d5a3eb70adaab960 extends Twig_Template
{
  ...
  <div class=\"form-group\">
    ...
    <div class=\"controls col-md-3 radios\">
      ";
        ...
        echo $this->env->getExtension('topxia_html_twig')->radios("wxpay_enabled", array(1 => "开启", 0 => "关闭"), $this->getAttribute($_payment_, "wxpay_enabled", array()));
        echo "
    </div>
  ...
  <div class=\"form-group\">
    ...
    <div class=\"controls col-md-8\">
      <input type=\"text\" id=\"wxpay_key\" name=\"wxpay_key\" class=\"form-control\" value=\"";
        // line 19
        if (isset($context["payment"])) { $_payment_ = $context["payment"]; } else { $_payment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_payment_, "wxpay_key", array()), "html", null, true);
        echo "\">
  ...
  <div class=\"form-group\">
    ...
    <div class=\"controls col-md-8\">
      <input type=\"text\" id=\"wxpay_account\" name=\"wxpay_account\" class=\"form-control\" value=\"";
        // line 28
        if (isset($context["payment"])) { $_payment_ = $context["payment"]; } else { $_payment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_payment_, "wxpay_account", array()), "html", null, true);
        echo "\">
  ...
  <div class=\"form-group\">
    ...
    <div class=\"controls col-md-8\">
      <input type=\"text\" id=\"wxpay_secret\" name=\"wxpay_secret\" class=\"form-control\" value=\"";
        // line 37
        if (isset($context["payment"])) { $_payment_ = $context["payment"]; } else { $_payment_ = null; }
        echo twig_escape_filter($this->env, $this->getAttribute($_payment_, "wxpay_secret", array()), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  69 => 37,  56 => 28,  43 => 19,  28 => 8,  19 => 1,);
    }
}
